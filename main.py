...
if __name__ == "__main__":
    ...
    if conn is not None:
        ...
        project = ("Nauka pythona", "2023-05-24 00:00:00", "2023-05-31 00:00:00")
        pr_id = add_project(conn, project)

        task = (1, "Nauczyc sie sqla", "sql jest fajny", "pending", "2023-05-24 00:00:00", "2023-05-31 00:00:00")
        ta_id = add_task(conn, task)

        table_p = "projects"
        print(select_all(conn, table_p))

        table_t = "tasks"
        print(select_all(conn, table_t))
